...
public class DemonstrativoRodape implements FlatFileFooterCallback {
	...
	@BeforeWrite
	public void beforeWriteGrupoLancamento(List<GrupoLancamento> lista) {
		for(GrupoLancamento grupoLancamento:lista) {
			totalGeral = totalGeral+grupoLancamento.getTotal();
		}
	}
	
	@AfterChunk
	public void depoisDeProcessarOGrupo() {
		totalGeral = 0.0;
	}
