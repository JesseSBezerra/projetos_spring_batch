...
import com.springbatch.demonstrativoorcamentario.writer.DemonstrativoRodape;
...
public class DemonstrativoOrcamentarioStepConfig {
	...
	public Step demonstrativoOrcamentarioStep(
			...
			MultiResourceItemWriter<GrupoLancamento> demostrativoMultiplo,
			DemonstrativoRodape demonstrativoRodape) {
		return stepBuilderFactory
				.get("demonstrativoOrcamentarioStep")
				.<GrupoLancamento,GrupoLancamento>chunk(1)
				.reader(demonstrativoOrcamentarioReader)
				.writer(demostrativoMultiplo)
				.listener(demonstrativoRodape)
				.build();
	}
}
